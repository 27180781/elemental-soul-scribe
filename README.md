...
> הבנייה מתבצעת אוטומטית בכל עדכון של הקוד. אם עדיין אין קבצים בדף ה‑Releases,
> הבנייה כנראה רצה כרגע — אפשר לעקוב אחריה בלשונית **Actions** של הפרויקט
> ב‑GitHub, והיא מסתיימת תוך כמה דקות.
